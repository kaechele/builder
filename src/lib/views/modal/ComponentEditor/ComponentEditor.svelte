...
<script>
  import _, { chain as _chain, cloneDeep, find } from 'lodash-es';
  import { setContext } from 'svelte';
  import GenericFields from '../../../components/GenericFields.svelte';
  import { CodePreview, Tabs } from '../../../components/misc';
      ...
      if (field.is_static) {
        ...
        combined_content = {
          ...
          [$locale]: {
            ...
            [field.key]:
              value !== undefined ? value : getCachedPlaceholder(field),
          },
        };
      } else {
...
<main
  class:showing-ide={$showingIDE}
  class:showing-cms={!$showingIDE}
  lang={$locale}
>
  <HSplitPane
